...
<main class="">
    <section class="flex flex-col gap-6 h-[90vh] justify-center p-12 text-center items-center">
        ...
        <h1 class="text-black text-4xl font-bold"> Persönlicher Trainings- und Ernährungsplan</h1>
        <p class="text-black text-xs font-light">Erschaffe neue Routinen, die perfekt auf dich abgestimmt sind. Kreiere Workouts, Logge deine Erfolge und erreiche deine Ziele.</p>
        <div class="flex flex-row items-center justify-evenly">
            <a href="#" class="bg-white border-[1px] border-solid px-4 py-3 w-[40%] text-xs">Mehr erfahren</a>
            <a href="start" class="bg-black text-white px-4 py-3 w-[55%] text-xs">Jetzt Starten ></a>
        </div>
    </section>
    ...
    {#if explainingSectionVisible}
        ...
        {#if buttonSectionVisible}
            <section in:fly={{duration:1500, y:50}} class="flex flex-col items-center justify-center h-[70vh] w-screen text-center p-8 gap-6">
                ...
                <a href="start" class="bg-black text-white w-[242px] h-[66px] text-2xl py-4 font-bold">Jetzt Loslegen</a>
            </section>
        {/if}
    {/if}
    </div>
