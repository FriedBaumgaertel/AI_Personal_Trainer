...
<svg width="120" height="120" viewBox="0 0 42 42" class="donut">
    ...
    <text x="50%" y="50%"  dominant-baseline="middle" text-anchor="middle" style="font-size:0.45rem; transform: translateY(-0.1em)" fill="#fff">{percentage}%</text>
