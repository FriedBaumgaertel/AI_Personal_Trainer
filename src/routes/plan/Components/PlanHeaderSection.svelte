...
<div class="flex flex-col w-full">
    <div class="flex flex-row justify-between items-center w-full">
        <div class="rounded-2xl bg-neutral-600 px-4 py-2 w-[28%] flex flex-row justify-evenly items-center text-white">
        ...
        <div class="w-1/3">
            <h1 class="text-4xl font-bold text-center">Plan</h1>
        </div>
        <div class="w-1/3 h-8"></div>
    </div>
